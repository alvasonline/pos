                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" readonly value="<?= $datos['nombre']?>" id="nombre" name="nombre" type="text" />
                                                    <label for="inputFirstName">Nombre</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" readonly value="<?= $datos['nombre_corto']?>" name="nombre_corto" id="nombre_corto" type="text"  />
