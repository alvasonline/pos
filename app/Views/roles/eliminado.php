...
<div id="layoutSidenav_content">
    <main>
        ...
        <div class="container mt-5 mb-3 px-4">
                <a name="" id="" class="btn btn-dark" href="<?= base_url('/roles') ?>" role="button"> <i class="fa-solid fa-arrow-left"></i> Regresar</a>
            </div>
            <div class="card mb-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn" role="group">
                                            ...
                                            <a href="#" data-href="<?= base_url() . '/Front/activarrol/'. $dato['id'] ?>" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal-confirma"><i class="fa-solid fa-circle-check"></i> </a>
                                            <!-- Modal -->
