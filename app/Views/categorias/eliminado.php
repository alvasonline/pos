                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                           Está seguro que desea activar la categoria <strong><?=$dato['nombre']?></strong>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-dark" data-bs-dismiss="modal">No</button>
                                                            <a href="<?= base_url().'/Front/activarcategoria/' . $dato['id'] ?>" class="btn btn-success"><i class="fa-solid fa-circle-check"></i> Si</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
