                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url() ?>/Front/actualizarproducto">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" autofocus value="<?= $datos['existencias'] ?>" id="existencia" name="existencia" type="text" required />
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" autofocus value="<?= $datos['stock_minimo'] ?>" id="stock_minimo" name="stock_minimo" type="text" required />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" autofocus value="<?= $datos['precio_compra'] ?>" id="precio_compra" name="precio_compra" type="text" required />
                                                    <label for="inputFirstName">Precio Compra</label>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" autofocus value="<?= $datos['precio_venta'] ?>" id="precio_venta" name="precio_venta" type="text" required />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control" name="inventariable" id="inventariable">
                                                        ...
                                                        <option <?php if($datos['inventariable']==1){echo "selected";}?> value="1" ?>Si</option>
                                                        <option <?php if($datos['inventariable']==0){echo "selected";}?>  value="0">No</option>
                                                    </select>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-control" name="unidades" id="unidades">
                                                        ...
                                                        <?php foreach ($unidades as $unidad) { ?>
                                                            <option <?php if($datos['id_unidad']==$unidad['id']){echo "selected";}?> value="<?= $unidad['id'] ?>"><?= $unidad['nombre'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-control" id="categorias" name="categorias">
                                                        ...
                                                        <?php foreach ($categorias as $categoria) { ?>
                                                            <option <?php if($datos['id_categoria']==$categoria['id']){echo "selected";}?> value="<?= $categoria['id'] ?>"><?= $categoria['nombre'] ?></option>
                                                        <?php } ?>
                                                    </select>
