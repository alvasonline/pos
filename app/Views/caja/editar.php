                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                <form method="POST" action="<?= base_url() ?>/Front/actualizarcaja">
                                        <input type="text" hidden value="<?= $datos['id'] ?>" name="id" class="form-control">
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" autofocus value="<?= $datos['folio'] ?>" id="folio" name="folio" type="text" required />
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" autofocus value="<?= $datos['numero_caja'] ?>" id="numero_caja" name="numero_caja" type="text" required />
                                                    <label for="inputFirstName">Numero Caja</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" value="<?= $datos['nombre'] ?>" name="nombre" id="nombre" type="text" required />
